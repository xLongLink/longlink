...
export const content = (
  ...
  <Column width="30">Sidebar</Column>
        ...
        <p className="leading-7">
            ...
            <code className="rounded bg-muted px-1 py-0.5 font-mono text-[0.9em] text-foreground">open</code> only when you
            need a controlled dialog.
        </p>
  ...
  <DialogContent>
    ...
    <DialogDescription>This cannot be undone.</DialogDescription>
        ...
        <ul className="ml-6 list-disc space-y-2">
            <li>
                <code className="rounded bg-muted px-1 py-0.5 font-mono text-[0.9em] text-foreground">space=&quot;center&quot;</code>{' '}
                centers the group.
            </li>
            <li>
                <code className="rounded bg-muted px-1 py-0.5 font-mono text-[0.9em] text-foreground">space=&quot;around&quot;</code>{' '}
                adds equal space around each item.
            </li>
            <li>
                <code className="rounded bg-muted px-1 py-0.5 font-mono text-[0.9em] text-foreground">space=&quot;between&quot;</code>{' '}
                pushes items to the edges.
            </li>
            <li>
                <code className="rounded bg-muted px-1 py-0.5 font-mono text-[0.9em] text-foreground">space=&quot;evenly&quot;</code>{' '}
