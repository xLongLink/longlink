...
export const content = (
    <div className="flex flex-col gap-4">
        ...
        <p className="leading-7">
            ...
            applications, and other software where people need to work with data, follow processes, and keep
        ...
        <p className="leading-7">
            The result is a simpler way to build operational software: less repeated infrastructure, clearer
            application boundaries, better visibility, and lower development and maintenance cost.
        </p>
        ...
        <p className="leading-7">
            ...
            their business logic, validation rules, workflows, data models, and integrations. When a process changes,
            a regulation changes, or a business rule needs to be updated, developers can focus on the application
            logic instead of navigating a large amount of unrelated infrastructure code.
        </p>
        <p className="leading-7">
            This makes applications faster to build, easier to understand, and cheaper to maintain. It also gives
            teams better visibility and control, because applications run inside one coordinated platform instead of
            being scattered across separate custom systems.
        </p>
        <p className="leading-7">
            LongLink is especially useful when building with AI-assisted development. Code can be produced quickly,
            but it still needs a clear structure to remain reliable. LongLink gives developers and AI a defined
            foundation to build on, so speed does not come at the cost of consistency.
        </p>
    </div>
);
