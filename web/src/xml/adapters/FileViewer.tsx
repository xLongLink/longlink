...
export function FileViewer({ props, nodes }: Props) {
    ...
    return (
        <Stack ref={frameRef} gap={3} height="65vh">
            {status === 'ready' && objectUrl != null && media === 'pdf' ? (
