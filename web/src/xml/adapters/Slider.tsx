...
import { resolveXmlProps, xmlNumericControlPropsSchema } from '../core/props';
...
export function Slider({ props }: Props) {
    ...
    const { label, max, min, step } = resolveXmlProps(props, ctx, xmlNumericControlPropsSchema, ['label']);
