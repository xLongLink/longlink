...
/** Returns whether a resolved XML scalar is one of an adapter's supported values. */
...
/** Returns whether a scalar is a number. */
export function isXmlNumber(value: XmlScalar): value is number {
