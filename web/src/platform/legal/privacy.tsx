...
export const metadata = {
    ...
    toc: [
        ...
        {
            id: 'automated-operational-actions',
            label: '9. Automated operational actions',
            level: 2,
        },
        {
            id: 'security-and-data-incidents',
            label: '10. Security and data incidents',
            level: 2,
        },
    ...
    return (
        <Stack gap={5}>
            ...
            <Stack as="section" gap={3}>
                ...
                <List listStyle="disc">
                    <ListItem
                        label={
                            <Text>
                                Account and identity data: internal account ID, name, email address, optional avatar
                                URL, platform role, account creation, update, deletion, and sign-in session information.
                            </Text>
                        }
                    />
                    <ListItem
                        label={
                            <Text>
                                Authentication data: password hashes, signed email-registration and password-reset
                                tokens, revocable session tokens, saved account identifiers, and safe post-login
                                redirect paths. The LongLink Platform does not store plaintext passwords or pending user
                                accounts.
                            </Text>
                        }
                    />
                    ...
                    <ListItem
                        label={
                            <Text>
                                ...
                                S3-compatible storage configuration, including endpoints, credentials, kubeconfigs,
                                proxy secrets, access keys, bucket names, database names, schema names, table metadata,
                    ...
                    <ListItem
                        label={
                            <Text>
                                ...
                                accounting records where we provide LongLink under a paid or managed service agreement.
                                This repository does not implement payment-card processing; full payment credentials are
                                handled by the selected payment or banking provider if a separate payment flow is used.
                            </Text>
                        }
                    />
                    <ListItem
                        label={
                            <Text>
                                Communications: messages, attachments, issue reports, security reports, and related
                                contact details when you contact us, request support, report a vulnerability, or
                ...
                <Text as="p">
                    We receive data directly from you, from your use of the Service, from the configured identity
                    provider, from organizations that invite or administer you, from connected infrastructure and
                    registries, from support or security channels, and from our operational systems.
                </Text>
                <Text as="p">
            ...
            <Stack as="section" gap={3}>
                ...
                <List listStyle="disc">
                    ...
                    <ListItem
                        label={
                            <Text>
                                create organizations, manage memberships, invitations, roles, and access controls;
                            </Text>
                        }
                    />
                    <ListItem
                    ...
                    />
                    <ListItem
                        label={<Text>send invitation, account, security, operational, and service messages;</Text>}
                    />
                    <ListItem
                        label={
                            <Text>
                    ...
                    <ListItem
                        label={
                            <Text>
                                comply with accounting, tax, sanctions, regulatory, security, and other legal
                                obligations.
                            </Text>
                        }
                    />
                ...
                <Text as="p">
                    ...
                    personality rights. Where another law requires a legal basis, including where the EU or UK GDPR
                    applies, we rely as appropriate on performance of a contract, compliance with legal obligations, our
                    legitimate interests in operating and protecting the Service, or consent for an optional use that
                    specifically requests it. You may withdraw consent at any time, without affecting earlier
                    processing.
                </Text>
            </Stack>
            ...
            <Stack as="section" gap={3}>
                ...
                <List listStyle="disc">
                    ...
                    <ListItem
                        label={
                            <Text>
                                Email and communications providers: delivery of invitations, account messages,
                                operational notices, security messages, and support communications. Email delivery
                                involves your email address, name, and the content of the message.
                            </Text>
                        }
                    />
                    <ListItem
                    ...
                    <ListItem
                        label={
                            <Text>
                                ...
                                regulatory, or public-authority recipients where reasonably necessary or where
                ...
                <Text as="p">
                    ...
                    independent controllers for their own security, fraud-prevention, service, and legal obligations.
            ...
            <Stack as="section" gap={3}>
                ...
                <Text as="p">
                    LongLink can be operated on customer-connected infrastructure. Personal data may therefore be
                    processed in Switzerland, the European Economic Area, the United States, or other countries where
                    we, our providers, a customer's providers, or their subprocessors operate.
                </Text>
                <Text as="p">
                    Where required, transfers are based on a destination recognized as providing adequate protection,
                    the Swiss-US Data Privacy Framework for a certified recipient, recognized standard contractual
                    clauses adapted for Swiss law, or another safeguard or exception permitted by applicable law. You
                    may contact us for more information about the safeguards relevant to a particular transfer.
                </Text>
            </Stack>
            ...
            <Stack as="section" gap={3}>
                ...
                <Text as="p">
                    ...
                    <Code>longlink_auth</Code> contains an opaque revocable session token. A short-lived HTTP-only
                    cookie named <Code>longlink_registration</Code> carries signed email proof while you complete
                    account setup. A signed cookie named <Code>longlink_session</Code> may contain saved account
                    identifiers used by the account switcher. Payment providers may set their own cookies when you visit
                    them.
                </Text>
                <Text as="p">
                ...
                <Text as="p">
                    We do not currently set advertising or cross-site behavioral-tracking cookies. If that changes, we
                    will update this Policy and provide any choices required by law before using them.
                </Text>
            </Stack>
            ...
            <Stack as="section" gap={3}>
                ...
                <List listStyle="disc">
                    <ListItem
                        label={
                            <Text>
                                account, profile, preference, membership, and invitation data are generally kept while
                                the account or organization is active and then deleted or anonymized when no longer
                                required for security, disputes, continuity, or legal obligations;
                            </Text>
                        }
                    />
                    <ListItem
                ...
                <Text as="p">
                    ...
                    required retention schedule. When deletion is due, we delete, anonymize, or securely isolate the
                    data until deletion from backups occurs in the ordinary cycle.
                </Text>
            </Stack>
            ...
            <Stack as="section" gap={3}>
                ...
                <Text as="p">
                    Subject to applicable conditions and exceptions, you may request access to personal data we hold
                    about you, correction of inaccurate data, deletion or restriction, object to processing, and receive
                    or transfer certain data in a commonly used machine-readable format. You may also request account
                    closure and withdraw consent where processing relies on consent.
                </Text>
                <Text as="p">
                    Send requests to{' '}
                    <Link href="mailto:info@longlink.ch" hasUnderline type="inherit">
                    ...
                    generally respond within 30 days. Access is normally free, although the law permits a fee for
                    manifestly unfounded, excessive, or disproportionately burdensome requests. We may retain or
                    withhold information where permitted or required by law and will explain an applicable restriction.
                </Text>
                <Text as="p">
