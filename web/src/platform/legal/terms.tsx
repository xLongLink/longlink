        ...
        <Stack as="section" gap={3}>
            ...
            <List listStyle="disc">
                ...
                <ListItem
                    label={
                        <Text>
                            ...
                            isolation, security controls, logging, metering, rate limits, image verification, deployment
                            checks, proxy controls, or platform protections;
                        </Text>
                    }
                />
                <ListItem
                    label={
                        <Text>
                            conduct destructive stress tests, sustained resource-abuse workloads, cryptocurrency mining,
                            or activity that harms shared or connected infrastructure without our prior written
                            approval;
                        </Text>
                    }
                />
                <ListItem
                    label={
                        <Text>
                            use anonymization, proxy, VPN, Tor, or similar tools to facilitate unlawful activity, evade
                            abuse controls, or conceal the source of attacks; or
                        </Text>
                    }
                />
                <ListItem
