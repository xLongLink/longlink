...
export const content = (
    <Stack gap={5}>
        ...
        <Stack gap={3}>
            ...
            <Text as="p">{'Use Badge for short, stable labels such as role, status, or category.'}</Text>
        </Stack>
        <Stack gap={3}>
...
export const metadata = {
    ...
    editUrl: 'https://github.com/xLongLink/longlink/edit/main/web/src/platform/docs/sdk/pages/badge.tsx',
};
