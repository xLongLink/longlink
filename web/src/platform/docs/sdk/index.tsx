...
export { metadata } from './index.metadata';
    ...
    return (
        <Stack gap={5}>
            ...
            <Text as="p">
                ...
                stays yours: it contains your data, rules, workflows, integrations, and API routes. LongLink does not
                replace the tools you already use. An Application is a normal FastAPI service, so you can structure and
            ...
            <Text as="p">
                ...
                database and storage access, identify the signed-in user, package the Application for deployment, and
                expose XML pages to the LongLink control plane. XML pages describe an Application interface in a
                structured way, so the Platform can display it consistently while the Application continues to own the
                information and actions behind each page.
            </Text>
            <LocalRuntimeDiagram />
