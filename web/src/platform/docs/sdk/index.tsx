...
export const content = (
    <Stack gap={5}>
        ...
        <Text as="p">
            The LongLink SDK helps you build Applications that work with the LongLink Platform. Your Application stays
            yours: it contains your data, rules, workflows, integrations, and API routes. LongLink does not replace the
            tools you already use. An Application is a normal FastAPI service, so you can structure and run it in the
            way that fits your team.
        </Text>
        <Text as="p">
            The SDK adds the parts that connect an Application to LongLink when you need them. It can provide database
            and storage access, identify the signed-in user, package the Application for deployment, and expose XML
            pages to the LongLink control plane. XML pages describe an Application interface in a structured way, so the
            Platform can display it consistently while the Application continues to own the information and actions
            behind each page.
        </Text>
        <LocalRuntimeDiagram />
