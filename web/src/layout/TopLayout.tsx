        ...
        <div className={cn('min-h-screen bg-background text-foreground', className)} {...props}>
            <div className="flex min-h-screen flex-col">
                ...
                <main className="mx-auto flex w-full flex-1 gap-8 p-0.5 lg:p-1">
                    <div className="flex w-full flex-1 flex-col overflow-hidden rounded-lg border border-border bg-card/80 px-6 py-4 shadow-[0_24px_80px_rgba(0,0,0,0.12)] backdrop-blur-sm">
