...
export function Dialog({ children, gap = 3, onOpenChange, purpose, subtitle, title, width = 640, ...props }: DialogProps) {
    return (
        <AstryxDialog {...props} aria-label={title} padding={0} width={width} onOpenChange={onOpenChange} purpose={purpose}>
            <Stack gap={0}>
                <Stack
