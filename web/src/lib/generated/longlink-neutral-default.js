...
/**
 * longlink-neutral-default theme — built by `bunx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { longlinkNeutralDefaultTheme } from './longlink-neutral-default';
 *   import './longlink-neutral-default.css';
 */
export const longlinkNeutralDefaultTheme = {
  name: 'longlink-neutral-default',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "\"Inter Variable\", -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
    "--font-family-heading": "\"Inter Variable\", -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
    ...
    "--color-background-body": "light-dark(oklch(1 0 0), oklch(0.145 0 0))",
    ...
    "--color-background-muted": "light-dark(oklch(0.97 0 0), oklch(0.235 0 0))",
    ...
    "--color-on-accent": "light-dark(oklch(0.985 0 0), oklch(0.205 0 0))",
