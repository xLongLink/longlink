...
describe('Typography', () => {
    ...
    it('renders styled heading and list markup end to end', () => {
        ...
        expect(output).toContain('class="group relative mt-10 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0"');
        ...
        expect(output).toContain('class="absolute left-0 top-1/2 inline-flex -translate-y-1/2 items-center text-muted-foreground opacity-0 transition-opacity hover:text-foreground group-hover:opacity-100 -translate-x-7"');
        expect(output).toContain('class="absolute left-0 top-1/2 inline-flex -translate-y-1/2 items-center text-muted-foreground opacity-0 transition-opacity hover:text-foreground group-hover:opacity-100 -translate-x-5"');
