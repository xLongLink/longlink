...
- The localization boundary is the text-bearing component itself. Use `i18n="..."` on `P`, `H1`, `Button`, and similar tags, then keep translation strings in the app catalog at `src/i18n/en.json`.
