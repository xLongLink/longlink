...
- [2. Authentication and Authorization](#2-authentication-and-authorization)
  - [2.1. Use of Tokens as Authorizations](#21-use-of-tokens-as-authorizations)
  - [2.2. Anonymous Requests](#22-anonymous-requests)
- [3. SCIM Protocol](#3-scim-protocol)
  - [3.1. Background](#31-background)
  - [3.2. SCIM Endpoints and HTTP Methods](#32-scim-endpoints-and-http-methods)
  - [3.3. Creating Resources](#33-creating-resources)
    - [3.3.1. Resource Types](#331-resource-types)
  - [3.4. Retrieving Resources](#34-retrieving-resources)
    - [3.4.1. Retrieving a Known Resource](#341-retrieving-a-known-resource)
    - [3.4.2. Query Resources](#342-query-resources)
    - [3.4.3. Querying Resources Using HTTP POST](#343-querying-resources-using-http-post)
  - [3.5. Modifying Resources](#35-modifying-resources)
    - [3.5.1. Replacing with PUT](#351-replacing-with-put)
    - [3.5.2. Modifying with PATCH](#352-modifying-with-patch)
  - [3.6. Deleting Resources](#36-deleting-resources)
  - [3.7. Bulk Operations](#37-bulk-operations)
    - [3.7.1. Circular Reference Processing](#371-circular-reference-processing)
    - [3.7.2. "bulkId" Temporary Identifiers](#372-bulkid-temporary-identifiers)
    - [3.7.3. Response and Error Handling](#373-response-and-error-handling)
    - [3.7.4. Maximum Operations](#374-maximum-operations)
  - [3.8. Data Input/Output Formats](#38-data-inputoutput-formats)
  - [3.9. Additional Operation Response Parameters](#39-additional-operation-response-parameters)
  - [3.10. Attribute Notation](#310-attribute-notation)
  - [3.11. "/Me" Authenticated Subject Alias](#311-me-authenticated-subject-alias)
  - [3.12. HTTP Status and Error Response Handling](#312-http-status-and-error-response-handling)
  - [3.13. SCIM Protocol Versioning](#313-scim-protocol-versioning)
  - [3.14. Versioning Resources](#314-versioning-resources)
...
- [6. Multi-Tenancy](#6-multi-tenancy)
  - [6.1. Associating Clients to Tenants](#61-associating-clients-to-tenants)
  - [6.2. SCIM Identifiers with Multiple Tenants](#62-scim-identifiers-with-multiple-tenants)
- [7. Security Considerations](#7-security-considerations)
  - [7.1. HTTP Considerations](#71-http-considerations)
  - [7.2. TLS Support Considerations](#72-tls-support-considerations)
  - [7.3. Authorization Token Considerations](#73-authorization-token-considerations)
  - [7.4. Bearer Token and Cookie Considerations](#74-bearer-token-and-cookie-considerations)
  - [7.5. Privacy Considerations](#75-privacy-considerations)
    - [7.5.1. Personal Information](#751-personal-information)
    - [7.5.2. Disclosure of Sensitive Information in URIs](#752-disclosure-of-sensitive-information-in-uris)
  - [7.6. Anonymous Requests](#76-anonymous-requests)
  - [7.7. Secure Storage and Handling of Sensitive Data](#77-secure-storage-and-handling-of-sensitive-data)
  - [7.8. Case-Insensitive Comparison and International Languages](#78-case-insensitive-comparison-and-international-languages)
- [8. IANA Considerations](#8-iana-considerations)
  - [8.1. Media Type Registration](#81-media-type-registration)
  - [8.2. Registering URIs for SCIM Messages](#82-registering-uris-for-scim-messages)
