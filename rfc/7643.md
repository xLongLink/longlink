...
- [2. SCIM Schema](#2-scim-schema)
  ...
  - [2.2. Attribute Characteristics](#22-attribute-characteristics)
  - [2.3. Attribute Data Types](#23-attribute-data-types)
    - [2.3.1. String](#231-string)
    - [2.3.2. Boolean](#232-boolean)
    - [2.3.3. Decimal](#233-decimal)
    - [2.3.4. Integer](#234-integer)
    - [2.3.5. DateTime](#235-datetime)
    - [2.3.6. Binary](#236-binary)
    - [2.3.7. Reference](#237-reference)
    - [2.3.8. Complex](#238-complex)
  - [2.4. Multi-Valued Attributes](#24-multi-valued-attributes)
  - [2.5. Unassigned and Null Values](#25-unassigned-and-null-values)
- [3. SCIM Resources](#3-scim-resources)
  - [3.1. Common Attributes](#31-common-attributes)
  - [3.2. Defining New Resource Types](#32-defining-new-resource-types)
  - [3.3. Attribute Extensions to Resources](#33-attribute-extensions-to-resources)
- [4. SCIM Core Resources and Extensions](#4-scim-core-resources-and-extensions)
  - [4.1. "User" Resource Schema](#41-user-resource-schema)
    - [4.1.1. Singular Attributes](#411-singular-attributes)
    - [4.1.2. Multi-Valued Attributes](#412-multi-valued-attributes)
  - [4.2. "Group" Resource Schema](#42-group-resource-schema)
  - [4.3. Enterprise User Schema Extension](#43-enterprise-user-schema-extension)
...
- [8. JSON Representation](#8-json-representation)
  - [8.1. Minimal User Representation](#81-minimal-user-representation)
  - [8.2. Full User Representation](#82-full-user-representation)
  - [8.3. Enterprise User Extension Representation](#83-enterprise-user-extension-representation)
  - [8.4. Group Representation](#84-group-representation)
  - [8.5. Service Provider Configuration Representation](#85-service-provider-configuration-representation)
  - [8.6. Resource Type Representation](#86-resource-type-representation)
  - [8.7. Schema Representation](#87-schema-representation)
    - [8.7.1. Resource Schema Representation](#871-resource-schema-representation)
    - [8.7.2. Service Provider Schema Representation](#872-service-provider-schema-representation)
- [9. Security Considerations](#9-security-considerations)
  - [9.1. Protocol](#91-protocol)
  - [9.2. Passwords and Other Sensitive Security Data](#92-passwords-and-other-sensitive-security-data)
  - [9.3. Privacy](#93-privacy)
- [10. IANA Considerations](#10-iana-considerations)
  - [10.2. URN Sub-namespace for SCIM](#102-urn-sub-namespace-for-scim)
    - [10.2.1. Specification Template](#1021-specification-template)
  - [10.3. Registering SCIM Schemas](#103-registering-scim-schemas)
    - [10.3.1. Registration Procedure](#1031-registration-procedure)
    - [10.3.2. Schema Registration Template](#1032-schema-registration-template)
  - [10.4. Initial SCIM Schema Registry](#104-initial-scim-schema-registry)
