...
def test_make_migrations_skips_when_alembic_returns_no_directives(tmp_path, monkeypatch) -> None:
    """Skip migration creation when Alembic generates no directives."""
    ...
    def fake_revision(
        ...
        """Run Alembic's callback without generated directives."""

        assert autogenerate is True
        process_revision_directives(object(), object(), [])
