...
VALID_FRAGMENTS = [
    ...
    ("p", _adapter_schema("p.xsd"), '<P i18n="items.name" name="$item.name" />'),
    ...
    ("tabs", _adapter_schema("Tabs.xsd"), '<Tabs defaultValue="overview"><Tab value="overview" label="Overview" icon="layout-grid"><P i18n="tabs.overviewPanel" /></Tab></Tabs>'),
...
INVALID_FRAGMENTS = [
    ...
    ("unsupported-p-value", _adapter_schema("p.xsd"), '<P value="$item.name" />'),
