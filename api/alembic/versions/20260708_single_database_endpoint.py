...
revision = "20260708_single_database_endpoint"
down_revision = "20260708_organization_country"
branch_labels = None
depends_on = None


def upgrade() -> None:
    """Remove separate application runtime database addresses."""
...
def downgrade() -> None:
    """Restore separate application runtime database addresses."""
