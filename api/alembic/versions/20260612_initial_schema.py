...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_id", sa.String(length=12), nullable=True),
        sa.Column("updated_id", sa.String(length=12), nullable=True),
        sa.Column("deleted_id", sa.String(length=12), nullable=True),
        sa.PrimaryKeyConstraint("id"),
