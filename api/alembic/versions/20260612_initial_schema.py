...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("avatar", sa.String(length=2048), nullable=True),
        sa.Column("location_id", sa.String(length=12), nullable=False),
        sa.Column("created_by_id", sa.String(length=12), nullable=True),
        sa.Column("updated_by_id", sa.String(length=12), nullable=True),
        sa.Column("deleted_by_id", sa.String(length=12), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    ...
    # Registry tables hang off locations and optionally track who deleted them.
    op.create_table(
        "compute_registries",
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
