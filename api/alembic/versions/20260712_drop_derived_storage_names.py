...
revision = "20260712_drop_derived_storage_names"
down_revision = "20260712_drop_compute_kind"
branch_labels = None
depends_on = None


def upgrade() -> None:
    """Drop storage bucket names that are derived from immutable slugs."""
...
def downgrade() -> None:
    """Restore derived storage bucket name columns for downgraded code."""
