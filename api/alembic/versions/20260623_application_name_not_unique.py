...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("user", "support", "administrator", name="platform_role_enum", native_enum=False),
            nullable=False,
        ),
        ...
        sa.Column(
            "radius", sa.Enum("none", "small", "medium", "large", name="radius", native_enum=False), nullable=False
        ),
        sa.Column(
            "language",
            sa.Enum(
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("creating", "running", "deleting", "failed", name="application_status_enum", native_enum=False),
            nullable=False,
        ),
        sa.Column("created_id", sa.Uuid(), nullable=True),
        sa.Column("updated_id", sa.Uuid(), nullable=True),
