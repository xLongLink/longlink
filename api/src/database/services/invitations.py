...
class InvitationsService:
    """Manage organization invitation records."""
    ...
    async def create(self, organization_id: UUID, email: str, role_name: OrganizationRoles, user: User) -> OrganizationInvitation:
